...
@property (nonatomic, strong) YTBannerLoopView *bannerView;
...
- (void)viewDidLoad {
    ...
    [self.bannerView setPageControlOriginType:(YTBannerPageControlOriginType_bottom)];
